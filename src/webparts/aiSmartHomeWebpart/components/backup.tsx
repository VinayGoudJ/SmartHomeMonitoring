    ...
    return (
      <section className={`${styles.aiSmartHomeWebpart} ${hasTeamsContext ? styles.teams : ''}`}>
        ...
        <div>
          ...
          <p>
            The SharePoint Framework (SPFx) is a extensibility model for Microsoft Viva, Microsoft Teams and SharePoint. It&#39;s Hello matic hosting and industry standard tooling.
          </p>
